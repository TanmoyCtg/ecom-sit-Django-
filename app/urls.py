...
from . views import home,products,customer,createOrder, updateOrder, deleteOrder, \
    registerPage, loginPage, logoutUser, userPage, accountSettings
...
urlpatterns = [
    ...
    path('reset_password_complete/', auth_views.PasswordResetView.as_view(template_name="app/password_reset_done.html"), name="password_reset_complete"),
